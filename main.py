...
def main():
    ...
    with sync_playwright() as p:
        ...
        for idx, row in ids_df.iterrows():
            ...
            logging.debug(
                "Processing row %d/%d: Program ID %s",
                idx + 1, len(ids_df), program_id)
            ...
            if (idx + 1) % checkpoint_interval == 0 or idx == 1:
                ...
                EXPECTED_FIELDS = [
                    'program_id', 'source_url', 'program_name_suffix', 'city', 'state',
                    'data_last_updated', 'accredited_training_length', 'required_training_length',
                    'affiliated_us_government', 'raw_ng_state_json', 'specialty_title',
                    ...
                    'special_features_text', 'accepting_applications_2025_2026',
                    'accepting_applications_2026_2027', 'program_start_dates', 'participates_in_eras',
                    'visa_statuses_accepted', 'program_director_first_name',
                    'program_director_middle_name', 'program_director_last_name',
                    'program_director_suffix', 'program_director_degrees', 'program_director_organization',
                    'program_director_address_line1', 'program_director_address_line2',
                    'program_director_locality', 'program_director_administrative_area',
                    'program_director_postal_code', 'program_director_email', 'program_director_phone',
                    'contact_first_name', 'contact_middle_name', 'contact_last_name', 'contact_suffix',
                    'contact_degrees', 'contact_organization', 'contact_address_line1',
                    'contact_address_line2', 'contact_locality', 'contact_administrative_area',
                    'contact_postal_code', 'contact_email', 'contact_phone']
                ...
                logging.info("Saved checkpoint to %s", filename)
    ...
    logging.info("✅ Completed scrape. Data saved to %s", output_csv)
